class Animal {
    ...
    getInfo() {
        return `animal's name: ${this.name}, animal's age: ${this.age}`;
    }
}
...
class Dog extends Animal {
    ...
    getInfo() {
        return `Dog's name: ${this.name}, breed: ${this.breed}, age: ${this.age}`;
    }
}
...
class Cat extends Animal {
    ...
    getInfo() {
        return `Cat's name: ${this.name}, color: ${this.color}, age: ${this.age}`;
    }
}
